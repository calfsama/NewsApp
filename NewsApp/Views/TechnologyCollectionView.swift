//
//  TechnologyCollectionView.swift
//  NewsApp
//
...
class TechnologyCollectionView: UICollectionView {
    let network = NetworkService()
    var pageNumber : Int = 1
    var articles: Articles?
    var titleName: String = "technology"
...
extension TechnologyCollectionView: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
