...
class SportsCollectionView: UICollectionView {
    let network = NetworkService()
    var pageNumber : Int = 1
    var articles: Articles?
    var titleName: String = "sports"
...
extension SportsCollectionView: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
