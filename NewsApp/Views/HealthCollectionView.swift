...
class HealthCollectionView: UICollectionView {
    let network = NetworkService()
    var pageNumber : Int = 1
    var articles: Articles?
    var titleName: String = "health"
...
extension HealthCollectionView: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
