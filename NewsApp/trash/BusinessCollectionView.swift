...
class BusinessCollectionView: UICollectionView {
...
extension BusinessCollectionView: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
